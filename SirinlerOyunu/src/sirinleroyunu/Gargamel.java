 ...
 * @author mypc
 */
public class Gargamel extends Düsman{
    
    //Hareket ---> olayları kontrol etcek her harekette
    ...
    int DüsmanID = 3;
    String DüsmanAdi ="Gargamel";
    Boolean DusmanTur=true;
    int ID = 3;
    String Ad = "Gargamel";
    Boolean Tur=false;
    int score;
    ...
    public Gargamel(int maze[][],int kkötüler[][],int bkötüler[][],int iyi,int score){
        this.maze=maze;
